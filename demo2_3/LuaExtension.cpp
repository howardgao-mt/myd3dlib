...
void Export2Lua(lua_State * L)
{
	...
	[
		...
		, class_<my::EffectParameterMap>("EffectParameterMap")
			...
			.def("SetVector", (void (my::EffectParameterMap::*)(const std::string &, const my::Vector3 &))&my::EffectParameterMap::SetVector)
			.def("SetVector", (void (my::EffectParameterMap::*)(const std::string &, const my::Vector4 &))&my::EffectParameterMap::SetVector)
